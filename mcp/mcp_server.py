...
client = MultiServerMCPClient(
    {
        "arith": {
            "transport": "stdio",
            "command": "/Users/rahulprajapati/miniconda3/envs/langchain/bin/python",
            "args": [
                "/Users/rahulprajapati/Documents/GitHub/LangGraph/mcp/mcp_client.py"
            ],
        }
    }
)
...
async def main():
    ...
    print(result['messages'][-1].content, file=sys.stderr)
